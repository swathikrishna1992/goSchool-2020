...
<body>
	...
	<!-- Header section -->
		...
		<div class="container" style="background-color: #605C63" >
		<header class="header-section" style="background-color:#1d4d4f">
			<div class="row" >
				<div class="col-lg-3 col-md-3">
					<div class="site -logo" >
					<spring:url value="/resources/images" var="images" />
   					<img src="${images}/back.png"/>
						<img src="/goSchool2020Validation/src/main/resources/bg.jpg" >
					</div>
				...
				<div class="col-lg-9 col-md-9">
					...
					<nav class="main-menu">
						...
						<li><a href=""></a></li>
							...
							<li><a href="/springmvc-user-reg-login">Home</a></li>
	...
	<!-- Hero section -->
	<section class="hero-section set-bg" data-setbg="/goSchool2020Validation/src/main/webapp/img/bg.jpg">
		<div class="container"  >
		<img alt="logo" src="<spring:url value="/bg.jpg"/>" width="2000">
	...
	<!-- banner section -->
	<section class="banner-section " style="background-color: #1d4d4f">
		<div class="container" style="background-color: #1d4d4f">
			<div class="section-title mb-0 pb-1" style="color: white;">
				<h2 style="color: white;">Pride In Excellence!</h2>
				<p style="color: white;">Welcome to goSchool </p>
			</div>
		</div>
	</section>
	<!-- banner section end -->
