...
<div class="menu"style="height: 90px">
  ...
  <a href="loginProcess"><h4>STUDENT DASHBOARD</a>
  </div>

<div class="container" style="padding-top: 30px;padding-left:120px ">
    <table class="table">
    <thead>
     <tr><th colspan="5"><h2><b>Student LIST</th></tr>
				<tr>
    ...
    <tbody>
				<tr>
					...
					<td>${std.middle_name}</td>
					<td>${std.last_name}</td>
					
					<td>${std.dob}</td>
					<td>${std.address}</td>
					<td>${std.gender}</td>
					<td><button class="btn btn-block" style="background-color:#6ba8a9 ;color:white;" onclick="window.location.href='edit'">EDIT</button><td>
					<td>
					</tr>
