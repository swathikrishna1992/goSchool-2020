...
.btn:hover, .btn:active, .btn.active, .btn.disabled, .btn[disabled] { background-color: #6ba8a9; }
.btn-large { padding: 9px 14px; font-size: 15px; line-height: normal; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; }
.btn:hover { color: #333333; text-decoration: none; background-color: #6ba8a9; background-position: 0 -15px; -webkit-transition: background-position 0.1s linear; -moz-transition: background-position 0.1s linear; -ms-transition: background-position 0.1s linear; -o-transition: background-position 0.1s linear; transition: background-position 0.1s linear; }
...
<div class="name" style="color: white;font-family: 'Times New Roman', Times, serif"><h2><b>goSchool</b></h4></div>
    ...
    <br><a href="/springmvc-user-reg-login/"><h2>HOME</a>
    <a href="aboutus"><h2>ABOUT US</a>
    <a href="contactus"><h2>CONTACT US</a>
  </div>
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                                  <b><h1 class="title" style="text-align: center;">Login</h1><br>
                
                <div class="login">
                <div style="padding-top: 10px">
    <form:input path="Username"  id ="un" type="text" name="Username" placeholder="Username"  />
    <form:errors path="Username" cssClass="msg"></form:errors>
    <span id="uerror"></span><br>
     <div style="padding-top: 10px">
        <form:input  path="Password" id="ps" type="password" name="password" placeholder="Password" />
            <form:errors path="Password" cssClass="msg"></form:errors>
        
        <span id="perror"></span><br>
        </div>
         <div style="padding-top: 10px">
        <form:button type="submit"   class=" btn-primary btn-block btn-large">Login</form:button>
        <br>
        </div>
