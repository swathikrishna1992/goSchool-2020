...
<body style="background-color: rgb(233, 227, 227)">
...
<div class="rightmenu">
<ul>
<c:if test="${sessionScope.Username!=null && sessionScope.userRole=='student'}">
<br><b><button class="btn btn-block" style="background-color:#6ba8a9 ;color:white;" onclick="window.location.href='logout'">Logout</button>
</c:if>
...
<c:redirect url="login.jsp"></c:redirect>
  ...
  <br>
  <a href="profiledetails"><h2>PROFILE</a>
  <a href="StdDetails"><h2>ADD DETAILS</a>
