...
<div class= "container-fluid" style="margin: 0px;padding: 0px;background-color:#e5dfdf">
...
<div class="menu"style="height: 90px">
    ...
    <br><a href="insertinfo"><h4>ADD SCHOOL DETAILS</a>
  <a href="showlist"><h4>VIEW STUDENT LIST</a>
